...
**ปัญหาที่เกิดขึ้น:**
- **ช่วงอายุ**: มีประมาณ 4-5 ช่วงอายุ → Cardinality ≈ 4-5 (ต่ำอยู่แล้ว แต่ยังดีกว่าอื่น)
  - แต่ละช่วงซ้ำ ~10,000-12,500 ครั้ง
  - **แต่ถ้าเก็บเป็น Calculated Column จะไม่ต้องใช้พื้นที่เลย** ✅

✅ **ดี (เก็บปีเกิด แล้วคำนวณช่วงอายุ - ไม่ต้องเก็บใน Model):**
...
**ข้อดี:**
- **ปีเกิด**: Cardinality ≈ 50-70 ค่า (ปีเกิดในช่วง 50-70 ปี)
  - แต่ละปีซ้ำ ~714-1,000 ครั้ง (50,000 ÷ 50-70) ✅
  - เก็บแค่ Integer → ใช้พื้นที่น้อย
...
**ผลลัพธ์:**
- ไม่ต้องเก็บ "ช่วงอายุ" ใน Model → **ประหยัดพื้นที่ 100%** ✅
- คำนวณแบบ Dynamic เมื่อ Query → ใช้ Memory อย่างมีประสิทธิภาพ
